...
<a href="dash.php">
      ...
      <a href="offres.php" class="active" data-role="admin">
  ...
  <main class="main">
    <div class="topbar"><div><h1>Offres</h1><div class="subtitle">Les formules d'accès vendues sur le hotspot</div></div></div>
    <div id="toast-container" class="toast-container" style="display:none;"><span id="toast-text"></span></div>
    <div class="card">
      <h3 id="titre-form">Ajouter une offre</h3>
      <form id="form-plan"><input type="hidden" id="edit-id">
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;">
          <div class="field"><label>Nom de l'offre</label><input type="text" id="plan-nom" required></div>
          <div class="field"><label>Durée (heures)</label><input type="number" id="plan-duree" required></div>
          <div class="field"><label>Prix (Ar)</label><input type="number" id="plan-prix" required></div>
        </div>
        <button type="submit" class="btn btn-primary" id="btn-plan">Ajouter l'offre</button><button type="button" class="btn btn-outline" id="btn-annuler" style="display:none">Annuler</button>
      </form>
    </div>
    <div class="card"><table id="table-plans"><thead><tr><th>Nom</th><th>Durée</th><th>Prix</th><th>Codes</th><th>Visibilité</th><th>Actions</th></tr></thead><tbody></tbody></table></div>
  </main>
</div>
